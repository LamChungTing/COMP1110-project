...
Input queue and table information into queue.txt/VIPqueue.txt and table.txt, simply run the queuing method of choice and output.txt should be generated, the final simulation statistics are in output.txt.
